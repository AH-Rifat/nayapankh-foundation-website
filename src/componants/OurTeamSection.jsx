    ...
    return (
        <div className='bg-slate-300 h-screen'>
            <div className='flex gap-x-8 justify-center items-center'>
                <div className='mt-12 p-8 w-1/2 text-center'>
                    <h1 className='text-xl underline font-semibold mb-2 text-slate-800'>JOIN OUR</h1>
                    <h1 className='text-7xl mb-8 font-bold text-fuchsia-600'>TEAM</h1>
                    ...
                    <button className='uppercase bg-white py-3 mt-4 px-7 rounded-lg font-semibold text-slate-800 hover:scale-110 hover:duration-200 duration-200'>JOIN US</button>
                </div>
